...
" Brief    : Open Apple Terminal.app tab window and change directory to current directory

let s:script_folder_path = expand( '<sfile>:p:h' )

" Terminal open
function! ROpenCurrentDirectoryWithTerminalAppleScript()
...
if !exists('g:terminalopener_no_default_key_mappings')
  noremap <Leader>e :call ROpenCurrentDirectoryWithTerminalAppleScript()<CR>
endif
